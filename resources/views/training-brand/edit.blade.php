{!! Form::model($training_brand,['id'=>'model-form','method' => 'PATCH','route' => ['training-brand.update', $training_brand->id]]) !!}
<div class="modal-header">
  <button mode="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">×</span>
  </button>
  <h4 class="modal-title darkblue-color">Edit Training Brand</h4>
</div>
<div class="modal-body">
  @include('training-brand.fields')
