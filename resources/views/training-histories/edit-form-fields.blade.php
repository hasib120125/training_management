...
<div class="row clearfix">
  <div class="col-sm-6">
    <div class="form-group required">
      ...
      <div class="form-line">
        {!! Form::text('user_duration', $training_history->approved_duration, array('id'=> 'user-duration','format' => "HH:mm:ss" ,'placeholder' => 'Duration in hour','class' => 'form-control')) !!}
      </div>
      <span class="help-block"></span>
    </div>
  </div>
...
<div class="row clearfix"> 
  <div class="col-sm-6">
    <div class="form-group">
      ...
      <div class="form-line">
        {!! Form::select('training_type_id', $training_types, null, array('id'=> 'training-type-id','class' => 'form-control select2', 'placeholder' => 'Please Select')) !!}
      </div>
      <span class="help-block"></span>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="form-group required">
      ...
      {!! Form::select('training_mode_id', $training_modes, null, array('id' => 'training-mode-id', 'class'=>'form-control select2', 'placeholder' => 'Please Select')) !!}
      <span class="help-block"></span>
    </div>
  </div>
</div>
...
<div class="row clearfix"> 
  <div class="col-sm-6">
    <div class="form-group">
      ...
      <div class="form-line">
        {!! Form::select('training_system_id', $training_system, null, array('id'=> 'training-system-id','class' => 'form-control select2', 'placeholder' => 'Please Select')) !!}
      </div>
      <span class="help-block"></span>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="form-group">
      ...
      {!! Form::select('training_brand_id', $training_brands, null, array('id' => 'training-brand-id', 'class'=>'form-control select2','placeholder' => 'Please Select')) !!}
      <span class="help-block"></span>
    </div>
  </div>
</div>
