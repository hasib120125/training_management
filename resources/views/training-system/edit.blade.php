{!! Form::model($training_system,['id'=>'model-form','method' => 'PATCH','route' => ['training-system.update', $training_system->id]]) !!}
<div class="modal-header">
  <button mode="button" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true">×</span>
  </button>
  <h4 class="modal-title darkblue-color">Edit Training System</h4>
</div>
